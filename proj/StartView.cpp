...
void CStartView::SetBitmap ()
{
	...
	m_Image.AddHotSpot (1, CRect (CPoint (25, 25), CSize (220, 50)));
...
//	m_Image.AddHotSpot (ID_VIEW_APP_LOOK, CRect (CPoint (220, 48), CSize (145, 18)));
	m_Image.AddHotSpot (ID_FILE_NEW, CRect (CPoint (295, 90), CSize (150, 15)));
	m_Image.AddHotSpot (ID_HELP_WEB, CRect (CPoint (295, 120), CSize (150, 15)));
	m_Image.AddHotSpot (ID_HELP_CONTACT, CRect (CPoint (385, 395), CSize (170, 20)));
}
